...
SCRIBE_PROMPT = (
    "You are analysing a single screenshot from a point-and-click adventure "
    "game. Only use information visible in this image. Do not draw on any "
    "prior knowledge you may have of this specific game -- treat it as "
    "entirely unfamiliar, even if you recognise it.\n\n"
    "Extract every interactable label, inventory item, and distinct "
    "physical object visible in the scene, including UI elements like verb "
