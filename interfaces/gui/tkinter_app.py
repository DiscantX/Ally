...
from interfaces.gui.models import OverlayConfig, FeedbackData, resolve_font_family, DEFAULT_DRAWER_OPEN
from interfaces.gui.chat_drawer import ChatDrawerMixin
from interfaces.gui.overlay_api import OverlayApiMixin
...
class AllyOverlay(tk.Tk, OverlayApiMixin, ChatDrawerMixin):
    ...
    def _open_settings(self):
        from interfaces.gui.settings_window import SettingsWindow
        SettingsWindow(self)
