...
DEFAULT_DB_PATH = os.path.join("cabinet", "data", "profiles", DEFAULT_PLAYER_ID, "memory.db")


class MemoryDB:
    def __init__(self, db_path: str | None = None, player_id: str = DEFAULT_PLAYER_ID) -> None:
        self.player_id = player_id
        self.db_path = db_path or os.path.join("cabinet", "data", "profiles", player_id, "memory.db")
